...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    keywordToReplace: 'temp-',     // Converts, for example, {keyword}Origin to Origin before sending to destination URL
  };
  ...
  return function(req, res) {
    ...
    for(var header in req.headers){
      if (header.includes(corsAnywhere.keywordToReplace)) {
        var headerWoKeyword = header.replace(corsAnywhere.keywordToReplace, '');
